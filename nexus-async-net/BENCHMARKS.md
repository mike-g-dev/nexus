...
Performance measurements for nexus-async-net — async WebSocket and REST
...
cargo build -p nexus-async-net --benches --release
...
|---------|-----|-----|------|
| **nexus-async-net (tokio)** | 64 | 188 | 224 |
| **nexus-async-net (nexus-async-rt)** | 64 | 184 | 206 |
...
| Backend | p50 | p99 | p999 |
|---------|-----|-----|------|
| **nexus-async-net (tokio)** | 96 | 228 | 266 |
| **nexus-async-net (nexus-async-rt)** | 84 | 218 | 246 |

### WebSocket recv per-message latency, batched x64 (amortized cycles/msg)

| Backend | Payload | p50 | p99 | p999 |
|---------|---------|-----|-----|------|
| nexus-async-net (tokio) | 40B | 48 | 72 | 146 |
| nexus-async-net (tokio) | 128B | 55 | 68 | 188 |
| nexus-async-net (nexus-async-rt) | 40B | 43 | (varies) | (varies) |
| nexus-async-net (nexus-async-rt) | 128B | 52 | (varies) | (varies) |
...
| Path | 40B | 128B |
|------|-----|------|
| nexus-async-net (tokio + TLS) | 54 ns/msg | 134 ns/msg |
